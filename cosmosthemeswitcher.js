...
function switchColor(event) {
  ...
  if(event.target.className === 'icon-close' || event.target.parentNode.className === 'icon-close' ) {
...
function RunCosmosDevTools() {
  var colorPicker = `<div onclick='switchColor(event);'><div><h4>Theme switcher</h4><button aria-label='close' class='icon-close'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" width="20px" height="20px" fill="currentColor">
